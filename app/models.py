...
class Preview(db.Model):
    ...
    title = db.Column(db.String(255), unique=True)  # 标题
    logo = db.Column(db.String(255), unique=True)  # 封面
    addtime = db.Column(db.DateTime, index=True, default=datetime.datetime.now())  # 上映时间
...
class Role(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True, default=datetime.datetime.now())  # 角色添加时间
